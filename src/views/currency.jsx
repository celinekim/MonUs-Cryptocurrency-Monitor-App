...
export class CurrencyView extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			unit: localStorage.getItem("unit") || "day",
	...
	render() {
		return (
			<div
				id="main-graph"
				className="container-wrapper color-container-wrapper"
			>
				...
				<div className="chart-container">
					<Graph
						...
						currency={[this.state.currency1, this.state.currency2]}

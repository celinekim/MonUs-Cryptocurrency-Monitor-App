...
export const MainGraph = () =>
	<div id="main-graph" class="container-wrapper color-container-wrapper">
		<div class="row">
			<div class="content-container col s12 l6">
				<h2 class="text-title">Main Graph</h2>
				<h3 class="text-subtitle">View real-time cryptocurrency data! Updated frequently.</h3>
			...
			<div class="image-container col s12 l6">
				<img class="responsive-img" src="http://via.placeholder.com/640x480"/>
			</div>
		</div>
	</div>;
